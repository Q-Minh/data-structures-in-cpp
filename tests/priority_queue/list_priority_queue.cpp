...
#include "priority_queue/list_priority_queue.h"

TEST_CASE("list_priority_queue remains sorted", "[list_priority_queue]")
{
	SECTION("given an empty list_priority_queue")
	{
		data_structures_cpp::list_priority_queue<int> queue{};
		REQUIRE(queue.empty());
